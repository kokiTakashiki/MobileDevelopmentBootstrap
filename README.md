...
- **`make setup`**: 新 Mac を 1 コマンドで開発可能な状態まで持っていく起動装置
  ...
  - Brewfile による GUI / CLI アプリの一括導入（JetBrains Toolbox / VSCode / Nix / direnv / xcodes / git / gh）
  - 手作業項目（`xcodes` による Xcode インストール・証明書・Toolbox 経由の Android Studio / IntelliJ・Android SDK・VSCode 拡張）の対話的ガイド
...
| `setup-manual` | xcodes による Xcode インストール / 証明書 / Toolbox 経由の IDE / Android SDK / VSCode 拡張の案内 | 手動（対話停止） |
...
<table width="100%">
  <tr><td align="center" colspan="2">🟧 <b>L4 ／ Brewfile（マシン単位） ─ brew bundle で適用</b></td></tr>
  <tr>
    <td align="center" width="50%">JetBrains Toolbox<br>VSCode<br>(cask)</td>
    <td align="center" width="50%">Nix / direnv<br>git / gh<br>xcodes</td>
  </tr>
</table>
...
<table width="100%">
  ...
  <tr>
    ...
    <td align="center" width="20%">JetBrains 製品<br>(Toolbox 経由)</td>
